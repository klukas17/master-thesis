...
\begin{table}[!htbp]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \hline
        random path topology partitioner change element chance & 0.6 \\
        \hline
...
\begin{table}[!htbp]
    ...
    \resizebox{\textwidth}{!}{
        ...
        topology partitioner scheme & k true random \\
        \hline
        random path topology partitioner change element chance & 0.5 \\
        \hline
...
\begin{table}[!htbp]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \hline
        random path topology partitioner change element chance & 0.8 \\
        \hline
        optimization algorithm & SSGA \\
        \hline
...
\begin{table}[!htbp]
    ...
    \resizebox{\textwidth}{!}{
        ...
        topology partitioner scheme & random path \\
        \hline
        random path topology partitioner change element chance & 0.9 \\
        \hline
